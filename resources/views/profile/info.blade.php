        ...
        <div class="col-sm-8 col-sm-offset-2">
          <form action="user/info/{{ Auth::user()->id }}" method="post" class="beta-form-checkout">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control password" name="changepassword" required placeholder="Nhập mật khẩu mới"/>
              <span style="color:red">{{ $errors->first('password') }}</span>
            </div>
            <div class="form-group">
              <label for="phone">Nhập lại mật khẩu</label>
              <input type="password" class="form-control password" name="re_password" required placeholder="Nhập lại mật khẩu">
