    ...
    <div class="col-md-10 col-md-offset-1 border">
      @foreach ($publishcompanies as $publishcompany)
        <div class="row borderlist">
          ...
          <div class="col-sm-2">
            <p class="h5"><a href="{{url('/editpublishcompany/'.$publishcompany->id)}}" class="glyphicon glyphicon-edit">Edit</a>&nbsp&nbsp&nbsp&nbsp<a href="" class="glyphicon glyphicon-trash">Delete</a></p>
          </div> 
        </div> 
      @endforeach
    </div>  
